...
export async function atualizarVitrine(diretorioRaiz=raiz) {
  ...
  const htmlPublico=html.replace('<title>','<meta name="robots" content="noindex,nofollow"><title>');
  await mkdir(join(diretorioRaiz,'previas'),{recursive:true}); await writeFile(join(diretorioRaiz,'previas','index.html'),htmlPublico,'utf8'); return publicacoes.length;
}
