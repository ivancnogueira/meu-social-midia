...
export async function criarJob(raiz, publicacao) {
  ...
  const job = { id, codigo: id, status: 'pronto_para_aprovar', criadoEm: agora, atualizadoEm: agora, publicacao, aprovadoPor: null, aprovadoEm: null, consumidoEm: null, resultado: null };
